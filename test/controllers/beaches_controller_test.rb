...
class BeachesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create beach' do
    assert_difference('Beach.count') do
      post beaches_url,
           params: { beach: { campground: @beach.campground, county: @beach.county, description: @beach.description,
                              location: @beach.location, name: @beach.name, parking: @beach.parking,
                              photo1: @beach.photo1, photo2: @beach.photo2, photo3: @beach.photo3,
                              photo4: @beach.photo4, restrooms: @beach.restrooms } }
    end
